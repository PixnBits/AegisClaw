...
test-e2e-contract:
	AEGIS_E2E_FIXTURE=1 bash scripts/run-playwright-e2e.sh e2e/journeys.spec.js e2e/portal-spec-journeys.spec.js e2e/portal-realtime.spec.js e2e/portal-progressive-reasoning.spec.js e2e/portal-mobile.spec.js e2e/portal-visual-polish.spec.js --project=chromium
