...
- 6+ (Phase 4/5): Remaining (more PM smarts like richer planning, portal channel roster/@mentions, etc.).

Update this doc + commit after each coherent portion. (PM end-to-end + Court + pools + this committed.)
