#!/usr/bin/env python3
"""Writes internal/builder/analysis.go — Diff, static analysis, and build step."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'builder', 'analysis.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"analysis.go: {len(code)} bytes -> {outpath}")
