#!/usr/bin/env python3
"""Writes internal/builder/builder_test.go — unit tests for builder runtime."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'builder', 'builder_test.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"builder_test.go: {len(code)} bytes -> {outpath}")
