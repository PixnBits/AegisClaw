#!/usr/bin/env python3
"""Writes internal/tui/components_test.go — tests for TUI components."""
import os
...
outpath = os.path.join(outdir, 'components_test.go')
with open(outpath, 'w') as f:
    f.write(code)
print(f"components_test.go: {len(code)} bytes -> {outpath}")
