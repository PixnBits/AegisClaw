#!/usr/bin/env python3
"""Writes internal/builder/iteration_test.go — Tests for iterative fix loop."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'builder', 'iteration_test.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"iteration_test.go: {len(code)} bytes -> {outpath}")
