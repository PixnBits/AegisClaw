#!/usr/bin/env python3
"""Writes internal/wizard/wizard_test.go — unit tests for the proposal wizard."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'wizard', 'wizard_test.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"wizard_test.go: {len(code)} bytes -> {outpath}")
