#!/usr/bin/env python3
"""Writes internal/builder/codegen.go — SkillSpec + CodeGenerator service."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'builder', 'codegen.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"codegen.go: {len(code)} bytes -> {outpath}")
