#!/usr/bin/env python3
"""Writes internal/builder/artifact.go — Artifact signing & packaging."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'builder', 'artifact.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"artifact.go: {len(code)} bytes -> {outpath}")
