#!/usr/bin/env python3
"""Writes internal/builder/pipeline.go — Proposal-to-Code Pipeline Orchestrator."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'builder', 'pipeline.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"pipeline.go: {len(code)} bytes -> {outpath}")
