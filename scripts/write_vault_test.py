#!/usr/bin/env python3
"""Writes internal/vault/vault_test.go — comprehensive tests for the secret vault."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'vault', 'vault_test.go')
outpath = os.path.abspath(outpath)
with open(outpath, 'w') as f:
    f.write(code)
print(f"vault_test.go: {len(code)} bytes -> {outpath}")
