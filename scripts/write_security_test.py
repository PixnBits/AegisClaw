#!/usr/bin/env python3
"""Writes internal/vault/security_test.go — security tests for secret isolation."""
import os
...
outpath = os.path.join(os.path.dirname(__file__), '..', 'internal', 'vault', 'security_test.go')
